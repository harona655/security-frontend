...
const MainHeader = function () {
  ...
  const section7 = useScrollSection('section7');
              ...
              <NavLink to="/">
                {IsMobile() ? (
                  <img
                    ...
                    className="img-fluid w-[120px] pl-7"
                    alt="#"
                  />
                ) : (
                  <img
                    src="/images/logo/logo7.png"
                    className="img-fluid w-[105px]"
                    alt="#"
                    width="150"
                  />
                )}
          ...
          <BreakpointProvider>
            <Breakpoint l down>
              <Popover
                ...
                <div className='navbar-item'>
                  <span onClick={() => { section7.onClick(); handleClose(); }} selected={section7.selected}>
                    Contact Us
                  </span>
                </div>
              </Popover>
            ...
            <Breakpoint xl>
              <div className='menu'>
                <div className='navbar-item'>
                  <span onClick={section1.onClick} selected={section1.selected}  className="text-[24px]">
                    Home
